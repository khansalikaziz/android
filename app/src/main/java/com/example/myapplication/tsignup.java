    ...
    private void uploadpicture() {
        ...
        riversRef.putFile(imageUri)
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(tsignup.this, "image upload fail", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
               ...
               /* User user=new User();
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(tsignup.this, "Please write your Email...", Toast.LENGTH_SHORT).show();
                }

                if (TextUtils.isEmpty(pass)) {
                    Toast.makeText(tsignup.this, "Please write your Password...", Toast.LENGTH_SHORT).show();
                }
                                ...
                                auth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                            ...
                                            customersDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Teacher").child(customerid);
                                            ...
                                            startActivity(new Intent(tsignup.this, teacherlogin.class));
                                            Toast.makeText(tsignup.this, "Account created successfully please verify your mail", Toast.LENGTH_SHORT).show();
                                            dialog.dismiss();


                                        }
                                        else{
                                            Toast.makeText(tsignup.this, "Error", Toast.LENGTH_SHORT).show();
                                            dialog.dismiss();
                                        }
                                    }
                                });
